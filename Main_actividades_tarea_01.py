...
from Actividades_21_25 import ventana_21_25    #Importar la función 'ventana_21_25' desde el archivo 'Actividades_16_20'
...
tk.Button(ventana_principal, text="Actividad 26 - 30", command=ventana_1_5, font=("Arial", 16, "bold"), bg="cornsilk2").pack(pady=5)
