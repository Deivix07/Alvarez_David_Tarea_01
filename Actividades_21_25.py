...
def ventana_21_25():
    ...
    ventana_21_25.title("Actividades 6 a 10")
    ...
    tk.Button(ventana_21_25, text="Actividad 25 : Promedio de calificaciones", command=descendente, font=("Times", 12, "bold"), bg="pale green").pack(pady=5)  